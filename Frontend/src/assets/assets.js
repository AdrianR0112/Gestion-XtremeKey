...
export const dummyWorkspaces = [
        ...
        "projects": [
            {
                ...
                "name": "LaunchPad CRM",
                "description": "Un CRM de nueva generacion para startups para gestionar embudos de clientes, analiticas y automatizacion.",
                "priority": "HIGH",
                "status": "ACTIVE",
                ...
                "tasks": [
                    {
                        ...
                        "title": "Disenar interfaz del panel",
                        "description": "Crear un diseno moderno y responsivo del panel del CRM.",
                        "status": "IN_PROGRESS",
                        "type": "FEATURE",
                        "priority": "HIGH",
                        "assigneeId": "user_1",
                    ...
                    },
                    {
                        ...
                        "projectId": "4d0f6ef3-e798-4d65-a864-00d9f8085c51",
                        "title": "Integrar API de correo",
                        "description": "Configurar la integracion con SendGrid para campanas de correo.",
                        "status": "TODO",
                        "type": "TASK",
                        "priority": "MEDIUM",
                        "assigneeId": "user_2",
                    ...
                    },
                    {
                        ...
                        "projectId": "4d0f6ef3-e798-4d65-a864-00d9f8085c51",
                        "title": "Corregir error de contactos duplicados",
                        "description": "Aparecen registros duplicados al importar archivos CSV.",
                        "status": "TODO",
                        "type": "BUG",
                        "priority": "HIGH",
                        "assigneeId": "user_1",
                    ...
                    },
                    {
                        ...
                        "projectId": "4d0f6ef3-e798-4d65-a864-00d9f8085c51",
                        "title": "Agregar control de acceso basado en roles (RBAC)",
                        "description": "Definir roles y permisos de usuario para el panel.",
                        "status": "IN_PROGRESS",
                        "type": "IMPROVEMENT",
                        "priority": "MEDIUM",
                        "assigneeId": "user_2",
            ...
            },
            {
                ...
                "name": "Renovacion de identidad de marca",
                "description": "Renovar productos del cliente con paletas de color y sistemas tipograficos coherentes.",
                "priority": "MEDIUM",
                "status": "PLANNING",
                ...
                "tasks": [
                    {
                        ...
                        "title": "Crear nuevos conceptos de logo",
                        "description": "Bocetar y finalizar 3 conceptos de logo para revision del cliente.",
                        "status": "IN_PROGRESS",
                        "type": "FEATURE",
                        "priority": "MEDIUM",
                        "assigneeId": "user_2",
                    ...
                    },
                    {
                        ...
                        "projectId": "e5f0a667-e883-41c4-8c87-acb6494d6341",
                        "title": "Actualizar sistema tipografico",
                        "description": "Introducir nueva jerarquia de fuentes con escalado responsivo.",
                        "status": "TODO",
                        "type": "IMPROVEMENT",
                        "priority": "MEDIUM",
                        "assigneeId": "user_1",
                    ...
                    },
                    {
                        ...
                        "projectId": "e5f0a667-e883-41c4-8c87-acb6494d6341",
                        "title": "Integracion de feedback del cliente",
                        "description": "Implementar ajustes solicitados por el cliente en la guia de marca.",
                        "status": "TODO",
                        "type": "TASK",
                        "priority": "LOW",
                        "assigneeId": "user_2",
    ...
    {
        "id": "org_2",
        "name": "Centro de Operaciones Cloud",
        "slug": "cloud-ops-hub",
        "description": null,
        "settings": {},
        "ownerId": "user_3",
        ...
        "projects": [
            {
                ...
                "name": "Migracion a Kubernetes",
                "description": "Migrar la infraestructura de la app monolitica a Kubernetes para escalar.",
                "priority": "HIGH",
                "status": "ACTIVE",
                ...
                "tasks": [
                    {
                        ...
                        "description": "Ejecutar escaneos de vulnerabilidades en contenedores y revisar roles IAM.",
                        "status": "TODO",
                        "type": "OTHER",
                        "priority": "MEDIUM",
                        "assigneeId": "user_3",
                    ...
                    },
                    {
                        ...
                        "projectId": "c45e93ec-2f68-4f07-af4b-aa84f1bd407c",
                        "title": "Configurar cluster EKS",
                        "description": "Aprovisionar un cluster EKS en AWS y configurar nodos.",
                        "status": "TODO",
                        "type": "TASK",
                        "priority": "HIGH",
                        "assigneeId": "user_1",
                    ...
                    },
                    {
                        ...
                        "description": "Agregar pasos de build, pruebas y despliegue con GitHub Actions.",
                        "status": "TODO",
                        "type": "TASK",
                        "priority": "MEDIUM",
                        "assigneeId": "user_2",
            ...
            },
            {
                ...
                "name": "Producto: Suite automatizada de regresion",
                "description": "Framework hibrido de pruebas Selenium + Playwright para pruebas de regresion.",
                "priority": "MEDIUM",
                "status": "ACTIVE",
                ...
                "tasks": [
                    {
                        ...
                        "title": "Migrar a Playwright 1.48",
                        "description": "Actualizar scripts para usar las ultimas funciones de Playwright.",
                        "status": "IN_PROGRESS",
                        "type": "IMPROVEMENT",
                        "priority": "HIGH",
                        "assigneeId": "user_1",
                    ...
                    },
                    {
                        ...
                        "projectId": "b190343f-a7b1-4a40-b483-ecc59835cba3",
                        "title": "Ejecucion paralela de pruebas",
                        "description": "Habilitar ejecuciones concurrentes de pruebas en pipelines de CI.",
                        "status": "TODO",
                        "type": "TASK",
                        "priority": "MEDIUM",
                        "assigneeId": "user_2",
                    ...
                    },
                    {
                        ...
                        "projectId": "b190343f-a7b1-4a40-b483-ecc59835cba3",
                        "title": "Comparacion de capturas visuales",
                        "description": "Implementar comparacion de capturas para detectar regresiones de interfaz.",
                        "status": "TODO",
                        "type": "FEATURE",
                        "priority": "LOW",
                        "assigneeId": "user_1",
